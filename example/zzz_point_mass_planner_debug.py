...
class Planner:
    ...
    def plan(self, init, goal):
        ...
        print("plan_x", plan_x, "plan_dx", plan_dx)
...
class Animate:
    ...
    def __init__(self, animate):
        ...
        #self.ax['birdseye'].add_patch(plt.Rectangle(xy=self.obs_pos, width=2*self.planner.pm_width, height=2*self.planner.pm_height, angle=15.0, color='black'))
        ...
        self.pm_visual = plt.Rectangle(xy=self.rectangle_init, width=2*self.planner.pm_width, height=2*self.planner.pm_height, angle=0.0, color='black')
